...
count_pp_revboom_batting_first = uber_pd['pp_revboom_batting_first'].sum()
count_pp_revboom_batting_second = uber_pd['pp_revboom_batting_second'].sum()
...
print("  Batting first, then winning Powerplay : ", count_pp_winner_batting_first)
print("    Batting first, then winning Powerplay, then winning match : ", count_pp_boom_batting_first)
print("    Batting first, then winning Powerplay, then losing match : ", count_pp_unboom_batting_first)
print("  Batting first, then losing Powerplay : ", total_matches_count - count_pp_winner_batting_first)
print("    Batting first, then losing Powerplay, then winning match : ", count_pp_revboom_batting_first)
print("    Batting first, then losing Powerplay, then losing match : ", total_matches_count - count_pp_winner_batting_first - count_pp_revboom_batting_first)
print("-----------------------------------------------------")
print("  Batting second, then winning Powerplay : ", count_pp_winner_batting_second)
print("    Batting second, then winning Powerplay, then winning match : ", count_pp_boom_batting_second)
print("    Batting second, then winning Powerplay, then losing match : ", count_pp_unboom_batting_second)
print("  Batting second, then losing Powerplay : ", total_matches_count - count_pp_winner_batting_second)
print("    Batting second, then losing Powerplay, then winning match : ", count_pp_revboom_batting_second)
print("    Batting second, then losing Powerplay, then losing match : ", total_matches_count - count_pp_winner_batting_second - count_pp_revboom_batting_second)

y = np.array([count_pp_winner_batting_first, total_matches_count - count_pp_winner_batting_first])
mylabels = ["Batting first, then winning Powerplay", "Batting first, then losing Powerplay"]
myexplode = [0.05, 0.05]
